...
const LoginPage = () => {
  ...
  return (<div className='min-h-screen grid lg:grid-cols-2'>
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="text-center mb-8">
              <div className="flex flex-col items-center gap-2 group">
                <div className="size-12 roudended-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors" >
            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
              ...
              <button type="submit" className="btn btn-primary w-full" disabled={isLoginUp}>
                {isLoginUp ? <>
            ...
            <div className='text-center'>
              <p className='text-base-content/60'>Don't have an account?{" "}
                <Link to="/signup" className='link link-primary'>Create one</Link> </p>
            </div>
          </div>
        </div>
        {/* right side */}
        <AuthImagePattern
          ...
          subtitle="Connect with friends, share moments, and stay in touch with your frinds" />
      </div>
  )
}

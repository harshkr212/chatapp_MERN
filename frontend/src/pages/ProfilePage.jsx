          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              ...
              className={`absolute bottom-0 right-0
                 bg-base-content hover:scale-125 p-2 rounded-full
            ...
            <p className='text-sm text-zinc-400'>{isUpdatingProfile?"Uploading...":"Click on camera icon to change profile picture"}</p>
          </div>
